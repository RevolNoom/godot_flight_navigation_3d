...
extends RefCounted
class_name ITriangleBoxOverlapCheck
...
func _abstract_fail(method_name: String) -> void:
	var message: String = "ITriangleBoxOverlapCheck.%s() is abstract. Override in subclass." % method_name
	push_error(message)
...
func projection_xy_overlaps(_minimum_corner: Vector3) -> bool:
	_abstract_fail("projection_xy_overlaps")
	return false
...
func projection_yz_overlaps(_minimum_corner: Vector3) -> bool:
	_abstract_fail("projection_yz_overlaps")
	return false
